...
function CarFactory (make, model){
  ...
  const myCar = new CarFactory ("Nissan", "Murano");
...
// It should take in three parameters: id (a number), title (a string) and rating (a number). Use these parameters to create 
// a new object and add it to the savedPosts array. Make sure to name the properties the same as described previously (id, title, rating).
...
// The first will be an id (a number) and the second will be the new rating (a number). Use the id to find the matching object in 
// the savedPosts array. Once you find the matching object, update it's rating score with the new rating parameter.
